...
const translations: Record<Language, any> = {
  pt: {
    ...
    statistics: {
      ...
      subtitle: 'Preencha os dados estatísticos coletivos e individuais',
      note: 'Observação: Ferramenta desenvolvida principalmente para analistas que não possuem computador',
      ...
      playerPhotoUrl: 'URL da imagem do jogador',
      kills: 'Kills',
      deaths: 'Mortes',
    ...
    picksBans: {
      ...
      selectBan: 'Selecionar Ban',
      selectPick: 'Selecionar Pick',
      ban: 'BAN',
      picks: 'PICKS',
      characters: 'PERSONAGENS',
      reset: 'Resetar',
  ...
  en: {
    ...
    statistics: {
      ...
      subtitle: 'Fill in collective and individual statistical data',
      note: 'Note: Tool developed primarily for analysts without computers',
  ...
  es: {
    ...
    statistics: {
      ...
      subtitle: 'Completa los datos estadísticos colectivos e individuales',
      note: 'Nota: Herramienta desarrollada principalmente para analistas sin computadora',
      ...
      playerPhotoUrl: 'URL de la imagen del jugador',
      kills: 'Eliminaciones',
      deaths: 'Muertes',
      assists: 'Asistencias',
      ...
      avgKills: 'Promedio de Eliminaciones',
      auto: 'Auto'
    },
    feedback: {
      title: 'Contáctanos',
    ...
    picksBans: {
      ...
      selectBan: 'Seleccionar Ban',
      selectPick: 'Seleccionar Pick',
      ban: 'BAN',
      picks: 'PICKS',
      characters: 'PERSONAJES',
      reset: 'Reiniciar',
  ...
  th: {
    ...
    statistics: {
      title: 'สถิติของทีม',
      subtitle: 'กรอกข้อมูลสถิติแบบรวมและแบบรายบุคคล',
      note: 'หมายเหตุ: เครื่องมือนี้พัฒนาขึ้นสำหรับนักวิเคราะห์ที่ไม่มีคอมพิวเตอร์',
      ...
      eventNamePlaceholder: 'เช่น: Copa GWL, ฝึกซ้อม 10 นาฬิกา',
      mapStats: 'สถิติตามแผนที่',
      player: 'ผู้เล่น',
      playerName: 'ชื่อผู้เล่น',
      enterName: 'ใส่ชื่อ',
      photoUrl: 'URL รูปภาพ',
      playerPhotoUrl: 'URL รูปผู้เล่น',
      kills: 'คิล',
      deaths: 'เสียชีวิต',
      assists: 'แอสซิสต์',
  ...
  id: {
    ...
    statistics: {
      title: 'Statistik Tim',
      subtitle: 'Isi data statistik kolektif dan individual',
      note: 'Catatan: Alat yang dikembangkan terutama untuk analis tanpa komputer',
      resetData: 'Reset Data',
      ...
      eventNamePlaceholder: 'Contoh: Copa GWL, Latihan 10h',
      mapStats: 'Statistik per Map',
      player: 'Pemain',
      playerName: 'Nama Pemain',
      enterName: 'Masukkan nama',
      photoUrl: 'URL Foto',
      playerPhotoUrl: 'URL gambar pemain',
      kills: 'Pembunuhan',
      deaths: 'Kematian',
      assists: 'Assist',
